<script>
	...
	// import LogoWhite from '$lib/assets/logo-flames-white.webp';
...
<footer
	class="fixed bottom-0 left-0 flex h-[66px] w-full flex-row items-center bg-yellow-50 tablet:hidden"
>
	<NavBottom />
</footer>

<aside id="modals" style="z-index:999;">
	<Modals {currentRoute} />
</aside>
